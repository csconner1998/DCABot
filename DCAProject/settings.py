"""
Django settings for DCAProject project.
...
MIDDLEWARE = [
    ...
    'DCAApp.middleware.LoginRequiredMiddleware',

]

LOGIN_REDIRECT_URL = '/'  # Redirects to the homepage after login

ROOT_URLCONF = 'DCAProject.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, 'templates'),  # Include the project-level templates directory
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'DCAProject.wsgi.application'
